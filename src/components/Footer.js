		...
		<main className="wrapper font-noto mt-10 border-t">
			<section className="md:flex justify-between  py-8">
				<div className="flex flex-col justify-between">
					...
					<div className="md:flex gap-1 sm:hidden">
						<span>
							<BiLogoFacebook
								size={22}
				...
				<div className="grid sm:grid-cols-2 md:grid-cols-3 gap-x-8">
					{footerLinks.map((footerLink) => (
						<div key={footerLink.key}>
							<h3 className="sm:text-[12.5px] md:text-[13px] font-bold">
								{footerLink.title}
							</h3>
			...
			{/* SM SOCIAL */}
			<div className="md:hidden gap-3 sm:flex items-center justify-center pb-4">
				<span>
					<BiLogoFacebook
						size={22}
						className="hover:text-accent cursor-pointer"
