...
const Hero = () => {
	return (
		<section className='gradientGreen wrapper h-full w-full'>
			<div className='flex'>
				<div className='w-[90%] md:w-3/5 font-noto py-14 px-2 md:px-6'>
					<h1 className='text-4xl md:text-6xl font-bold leading-tight mb-6 mr-0 md:mr-16'>
						Design your home with our collection.
					</h1>
					<p className='text-[13px] md:text-sm font-light mb-6 mr-0 md:mr-16'>
				...
				{/* Right hero */}
				<div className='hidden md:flex md:w-2/5 md:py-6 '>
					<img
						src={heroBg}
						alt='hero'
