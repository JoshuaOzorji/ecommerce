		...
		return (
			<section className=''>
				...
				<div className='wrapper font-noto flex flex-col items-center justify-center'>
					<img src={emptyCart} alt='empty cart' className='md:h-72 h-40' />
					<h2 className='mb-1'>Your cart is empty</h2>
					<Link
						to='/products'
						className='border rounded-lg border-accent py-[1px] px-2 md:py-1 md:px-2 cursor-pointer hover:text-accent font-semibold md:text-sm text-sm'>
						Continue shopping
					</Link>
				</div>
			</section>
